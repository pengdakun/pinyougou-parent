...
<body ng-app="pinyougouAPP" ng-controller="itemController" ng-init="loadSku();num=1">

<#include "head.ftl">
<#assign imageList=goodsDesc.itemImages?eval>
<#assign customerAttr=goodsDesc.customAttributeItems?eval>
						...
						<#list specList as spec>
							<dl>
								...
								<#list spec.attributeValue as value>
									<dd><a class="{{isSelect('${spec.attributeName}','${value}')?'selected':''}}" ng-click="selectSpec('${spec.attributeName}','${value}')" href="javascript:;">${value}<span title="点击取消选择">&nbsp;</span></a></dd>
								</#list>
							</dl>
						</#list>
						...
						<div class="summary-wrap">
							...
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<a ng-click="addToCat()" target="_blank" class="sui-btn  btn-danger addshopcar">加入购物车</a>
									</li>
								</ul>
							</div>
						</div>
