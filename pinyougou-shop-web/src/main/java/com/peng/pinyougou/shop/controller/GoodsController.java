...
public class GoodsController {
	...
	public Result update(@RequestBody Goods goods){
		try {
			//判断修改商品是否为该商家商品
			String sellerId = SecurityContextHolder.getContext().getAuthentication().getName();
			Goods findOne = goodsService.findOne(goods.getTbGoods().getId());
			if(sellerId.equals(findOne.getTbGoods().getSellerId()) && sellerId.equals(goods.getTbGoods().getSellerId())){
